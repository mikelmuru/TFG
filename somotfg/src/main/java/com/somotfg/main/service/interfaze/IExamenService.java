...
public interface IExamenService {
    ...
    GenericResponse<List<ExamenDTO>> searchByAsignatura(String asignaturacod) throws Exception;
    GenericResponse<List<ExamenDTO>> searchByFiltro(String filtro) throws Exception;

    // SAVE METHODS
    GenericResponse<ExamenDTO> create(ExamenNewDTO newExamen, MultipartFile file) throws Exception;
