...
public class LogInController {
    ...
    public ResponseEntity<Map<String, String>> logIn(@RequestBody AppUserDTO userdto) {
    ...
    public ResponseEntity<GenericResponse<AppUserDTO>> singUp(@RequestBody AppUserDTO userdto) throws Exception {
